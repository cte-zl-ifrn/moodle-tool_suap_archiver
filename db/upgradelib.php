...
require_once($CFG->dirroot . '/admin/tool/suap_archiver/locallib.php');

function tool_suap_archiver_migrate($oldversion) {
    global $DB;

    $dbman = $DB->get_manager();

    $table = new xmldb_table("suap_archiver_processing");
